...
complexity:
    - time complexity of O(n * n/(k)) = O(n^2/k) where k is the smallest number in nums. This
      is because there is at most n/k layers in the tree, and at each layer we need to process
      at most n elements.

    - space complexity of O(n/k) since the stack is at most n/k deep 
"""
